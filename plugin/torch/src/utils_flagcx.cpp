                        ...
                        std::optional<std::string> processGroupFailureReason /* = std::nullopt */) 
    {
        ...
        switch (error)
        {
            ...
            case flagcxSystemError:
                interpret =
                    "flagcxSystemError: System call (e.g. socket, malloc) or external library call failed or device error. ";
                break;
            case flagcxRemoteError:
                interpret = "flagcxRemoteError: A call failed possibly due to a network error or a remote process exiting prematurely.";
                break;
            ...
            case flagcxInvalidUsage:
                interpret = "flagcxInvalidUsage: This usually reflects invalid usage of Flagcx library.";
                break;
            default:
